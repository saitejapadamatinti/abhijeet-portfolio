        ...
        <div className="home-banner-div">
          ...
          <div className="home-banner-heading-div">
            ...
            <p className="home-banner-para">
              Creating Impactful Marketing Campaigns and Building Strong Brands
              for Sustainable Success.
            </p>
            <div className="home-banner-buttons-div">
              <button className="outline-button"> <BiDownload className="download-button-icon" />  Resume</button>
          ...
          <div className="about-main-container">
            <div className="about-images-container">
              ...
              <div className="about-images-div-3">
                ...
                <div className="about-images-6">
                  
                </div>
                <div className="about-images-7">
            ...
            <div className="about-section-content">
              <p>
                ...
                Abhijeet Patil, an experienced professional dedicated to driving
                business success through strategic thinking, innovative ideas,
                and a relentless pursuit of excellence. As a marketing
                enthusiast, I possess a unique blend of skills, education, and
                hands-on experiences that set me apart in the industry.
              </p>
              <br />
              <p>
                Combining my technical foundation with a keen business acumen, I
                have developed a versatile skill set encompassing strategic
                ...
                drive tangible results. Furthermore, my entrepreneurial mindset
                empowers me to think outside the box, identifying innovative
                solutions and leveraging emerging trends to stay ahead of the
                curve.
              </p>
              <br />
              <p>
                What truly sets me apart is my unwavering passion for marketing
                and branding. I view each project as an opportunity to tell a
                captivating story, engage with audiences on a deeper level, and
                create lasting connections between brands and consumers. My
                innate ability to blend analytical thinking with creative flair
                enables me to develop unique strategies that not only deliver
                results but also leave a lasting impact. I am constantly seeking
                new challenges and opportunities to push the boundaries of what
                is possible in the field of marketing.
              </p>
            </div>
          </div>
        </div>
        <div>
        <HomeSectionNumber number={"03"} content={"Profesional Experiance"} />
          <div><ProfessionalSection /></div>
        </div>
      </div>
    </div>
  );
