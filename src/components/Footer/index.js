        ...
        <div className="footer-main-container ">
          <div className="middle-width-container footer-div-container ">
            <div>
              ...
              <p className="footer-questions-para">
                Questions or Feedback? <br /> I would love to hear from you!
              </p>
            ...
            <div className="ul-items-div footer-box-1">
              ...
              <ul>
                ...
                <li>
                  <a href={`${webUrl}/#AboutMe`}>About me</a>
                </li>
                <li>
                  <a href={`${webUrl}/#ProfessionalExperience`}>
                    Professional Experience
                  </a>
                </li>
                <li>
                  <a href={`${webUrl}/#Skills`}>Skills</a>
                </li>
                <li>
                  <a href={`${webUrl}/#Education`}>Education</a>
                </li>
                <li>
                  <a href={`${webUrl}/#Certifications`}>Certifications</a>
                </li>
              </ul>
            </div>
            ...
            <div className="ul-items-div footer-box-2">
              ...
              <ul>
                ...
                <li>
                  <a href={`${webUrl}/#ContactMe`}> Contact me</a>
                </li>
              </ul>
            </div>
            <div className="ul-items-div">
              ...
              <ul>
                ...
                <li>
                  <a href={`${webUrl}/#Newsletter`}>Newsletter</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <p className="footer-copy-text">
              Copyright &copy; 2023 Abhijeet Patil
            </p>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="footer-social-media-logos">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M18.0625 0H3.1875C2.34212 0 1.53137 0.335825 0.933598 0.933597C0.335825 1.53137 0 2.34212 0 3.1875V13.8125C0 14.6579 0.335825 15.4686 0.933598 16.0664C1.53137 16.6642 2.34212 17 3.1875 17H18.0625C18.9079 17 19.7186 16.6642 20.3164 16.0664C20.9142 15.4686 21.25 14.6579 21.25 13.8125V3.1875C21.25 2.34212 20.9142 1.53137 20.3164 0.933597C19.7186 0.335825 18.9079 0 18.0625 0ZM18.0625 2.125L11.1563 6.87438C10.9947 6.96763 10.8115 7.01672 10.625 7.01672C10.4385 7.01672 10.2553 6.96763 10.0938 6.87438L3.1875 2.125H18.0625Z"
                        fill="#545454"
                      />
                    </svg>
                  </a>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M6.3 10.35H8.55L9.45 6.75H6.3V4.95C6.3 4.023 6.3 3.15 8.1 3.15H9.45V0.126C9.1566 0.0873001 8.0487 0 6.8787 0C4.4352 0 2.7 1.4913 2.7 4.23V6.75H0V10.35H2.7V18H6.3V10.35Z"
                        fill="#545454"
                      />
                    </svg>
                  </a>
